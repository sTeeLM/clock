...
enum serial_hub_crl_bits{
  ...
  SERIAL_BIT_TRIPWIRE_TEST  = 5,
  SERIAL_BIT_THERMO_LO_TEST = 6,
  SERIAL_BIT_THERMO_HI_TEST = 7,
  SERIAL_BIT_FUSE1_SHORT_TEST = 8,
  SERIAL_BIT_FUSE1_BROKE_TEST = 9,
  SERIAL_BIT_FUSE0_SHORT_TEST = 10,
  SERIAL_BIT_FUSE0_BROKE_TEST = 11,
  SERIAL_BIT_HG3_FIX = 12,
  SERIAL_BIT_HG2_FIX = 13,
  SERIAL_BIT_HG1_FIX = 14,
  SERIAL_BIT_HG0_FIX = 15,
  SERIAL_BIT_FUSE1_TRIGGER = 16,
  SERIAL_BIT_FUSE0_TRIGGER = 17,
  SERIAL_BIT_TRIPWIRE_EN = 18,
  SERIAL_BIT_THERMO_LO_EN = 19,
  SERIAL_BIT_THERMO_HI_EN = 20,
