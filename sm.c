...
static const struct sm_trans code sm_trans_fuse_param[] = { 
  /* SM_FUSE_PARAM */
  {SM_FUSE_PARAM<<4|SM_FUSE_PARAM_INIT, EV_KEY_SET_UP, SM_FUSE_PARAM<<4|SM_FUSE_PARAM_DD, sm_fuse_param}, 
  // set0/1 调整日
  ...
  // 结尾从头开始
  {SM_FUSE_PARAM<<4|SM_FUSE_PARAM_PASSWORD, EV_FUSE_SEL0, SM_FUSE_PARAM<<4|SM_FUSE_PARAM_DD, sm_fuse_param},  
  // mod1 跳转电路测试
