...
static const struct sm_trans code sm_clock[] = 
{
  ...
  // mod0进入调整重复日状态
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_MM, EV_KEY_MOD_PRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY1, sm_mod_alarm}, 
  // mod1进入修改全局状态模式  
  ...
  // set0调整打开关闭，并写入rtc
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY1, EV_KEY_SET_PRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY1, sm_mod_alarm},
  // mod0进入修改下一天状态
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY1, EV_KEY_MOD_PRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY2, sm_mod_alarm}, 
  // mod1进入修改全局状态模式  
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY1, EV_KEY_MOD_LPRESS, SM_MODIFY_GLOBAL_FLAG<<4|SM_MODIFY_GLOBAL_FLAG_INIT, sm_mod_global_flag},

  // set0调整打开关闭，并写入rtc
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY2, EV_KEY_SET_PRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY2, sm_mod_alarm},
  // mod0进入修改下一天状态
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY2, EV_KEY_MOD_PRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY3, sm_mod_alarm}, 
  // mod1进入修改全局状态模式  
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY2, EV_KEY_MOD_LPRESS, SM_MODIFY_GLOBAL_FLAG<<4|SM_MODIFY_GLOBAL_FLAG_INIT, sm_mod_global_flag},

  // set0调整打开关闭，并写入rtc
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY3, EV_KEY_SET_PRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY3, sm_mod_alarm},
  // mod0进入修改下一天状态
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY3, EV_KEY_MOD_PRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY4, sm_mod_alarm}, 
  // mod1进入修改全局状态模式  
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY3, EV_KEY_MOD_LPRESS, SM_MODIFY_GLOBAL_FLAG<<4|SM_MODIFY_GLOBAL_FLAG_INIT, sm_mod_global_flag},

  // set0调整打开关闭，并写入rtc
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY4, EV_KEY_SET_PRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY4, sm_mod_alarm},
  // mod0进入修改下一天状态
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY4, EV_KEY_MOD_PRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY5, sm_mod_alarm}, 
  // mod1进入修改全局状态模式  
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY4, EV_KEY_MOD_LPRESS, SM_MODIFY_GLOBAL_FLAG<<4|SM_MODIFY_GLOBAL_FLAG_INIT, sm_mod_global_flag},

  // set0调整打开关闭，并写入rtc
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY5, EV_KEY_SET_PRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY5, sm_mod_alarm},
  // mod0进入修改下一天状态
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY5, EV_KEY_MOD_PRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY6, sm_mod_alarm}, 
  // mod1进入修改全局状态模式  
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY5, EV_KEY_MOD_LPRESS, SM_MODIFY_GLOBAL_FLAG<<4|SM_MODIFY_GLOBAL_FLAG_INIT, sm_mod_global_flag},

  // set0调整打开关闭，并写入rtc
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY6, EV_KEY_SET_PRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY6, sm_mod_alarm},
  // mod0进入修改下一天状态
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY6, EV_KEY_MOD_PRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY7, sm_mod_alarm}, 
  // mod1进入修改全局状态模式  
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY6, EV_KEY_MOD_LPRESS, SM_MODIFY_GLOBAL_FLAG<<4|SM_MODIFY_GLOBAL_FLAG_INIT, sm_mod_global_flag},

  // set0调整打开关闭，并写入rtc
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY7, EV_KEY_SET_PRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_DAY7, sm_mod_alarm},
  // mod0回到调整闹钟小时状态
  ...
  // mod0 进入闹铃音乐选择
  {SM_MODIFY_GLOBAL_FLAG<<4|SM_MODIFY_GLOBAL_FLAG_BS, EV_KEY_MOD_PRESS, SM_MODIFY_GLOBAL_FLAG<<4|SM_MODIFY_GLOBAL_FLAG_ALARM_MUSIC, sm_mod_global_flag},
  // mod1进入显示时间状态
  {SM_MODIFY_GLOBAL_FLAG<<4|SM_MODIFY_GLOBAL_FLAG_BS, EV_KEY_MOD_LPRESS, SM_DISPLAY<<4|SM_DISPLAY_INIT, sm_display}, 
  // set0 闹铃音乐设置
  {SM_MODIFY_GLOBAL_FLAG<<4|SM_MODIFY_GLOBAL_FLAG_ALARM_MUSIC, EV_KEY_SET_PRESS, SM_MODIFY_GLOBAL_FLAG<<4|SM_MODIFY_GLOBAL_FLAG_ALARM_MUSIC, sm_mod_global_flag},
  // mod0 进入1按键音设置
  {SM_MODIFY_GLOBAL_FLAG<<4|SM_MODIFY_GLOBAL_FLAG_ALARM_MUSIC, EV_KEY_MOD_PRESS, SM_MODIFY_GLOBAL_FLAG<<4|SM_MODIFY_GLOBAL_FLAG_BEEP, sm_mod_global_flag}, 
  // mod1进入显示时间状态
  {SM_MODIFY_GLOBAL_FLAG<<4|SM_MODIFY_GLOBAL_FLAG_ALARM_MUSIC, EV_KEY_MOD_LPRESS, SM_DISPLAY<<4|SM_DISPLAY_INIT, sm_display}, 
  // set0 打开关闭按键音
  {SM_MODIFY_GLOBAL_FLAG<<4|SM_MODIFY_GLOBAL_FLAG_BEEP, EV_KEY_SET_PRESS, SM_MODIFY_GLOBAL_FLAG<<4|SM_MODIFY_GLOBAL_FLAG_BEEP, sm_mod_global_flag},
  // mod0 进入1224小时设置状态
  {SM_MODIFY_GLOBAL_FLAG<<4|SM_MODIFY_GLOBAL_FLAG_BEEP, EV_KEY_MOD_PRESS, SM_MODIFY_GLOBAL_FLAG<<4|SM_MODIFY_GLOBAL_FLAG_1224, sm_mod_global_flag}, 
  // mod1进入显示时间状态
  {SM_MODIFY_GLOBAL_FLAG<<4|SM_MODIFY_GLOBAL_FLAG_BEEP, EV_KEY_MOD_LPRESS, SM_DISPLAY<<4|SM_DISPLAY_INIT, sm_display}, 
  // set0 1224模式切换
  ...
  // set0计次
  {SM_TIMER<<4|SM_TIMER_RUNNING, EV_KEY_SET_DOWN, SM_TIMER<<4|SM_TIMER_RUNNING, sm_timer},
  {SM_TIMER<<4|SM_TIMER_RUNNING, EV_KEY_SET_UP, SM_TIMER<<4|SM_TIMER_RUNNING, sm_timer},  
  // mod0跑表停止  
  {SM_TIMER<<4|SM_TIMER_RUNNING, EV_KEY_MOD_DOWN, SM_TIMER<<4|SM_TIMER_STOP, sm_timer},
  // mod0跑表清零
  {SM_TIMER<<4|SM_TIMER_STOP, EV_KEY_MOD_DOWN, SM_TIMER<<4|SM_TIMER_CLEAR, sm_timer},
  // set0逐次显示计次
