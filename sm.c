...
static const struct sm_trans code sm_trans_clock_display[] = 
{
  ...
  // 闹钟0响了
  {SM_DISPLAY<<4|SM_DISPLAY_HHMMSS, EV_ALARM0, SM_ALARM<<4|SM_ALARM_HIT_ALARM0, sm_alarm},
  // 闹钟1响了
  {SM_DISPLAY<<4|SM_DISPLAY_HHMMSS, EV_ALARM1, SM_ALARM<<4|SM_ALARM_HIT_ALARM1, sm_alarm},
  // 该进入节电模式了
  {SM_DISPLAY<<4|SM_DISPLAY_HHMMSS, EV_POWER_SAVE, SM_POWERSAVE<<4|SM_POWERSAVE_INIT, sm_powersave},
  // 进入跑表功能
  {SM_DISPLAY<<4|SM_DISPLAY_HHMMSS, EV_KEY_SET_LPRESS, SM_TIMER<<4|SM_TIMER_INIT, sm_timer},

  // 按modset1进入fuse功能集合
  {SM_DISPLAY<<4|SM_DISPLAY_HHMMSS, EV_KEY_MOD_SET_LPRESS, SM_FUSE_TEST<<4|SM_FUSE_TEST_INIT, sm_fuse_test},
...
static const struct sm_trans code sm_trans_clock_powersave[] = {
  /* SM_POWERSAVE */
  // 250ms后进入睡眠
  {SM_POWERSAVE<<4|SM_POWERSAVE_INIT, EV_250MS, SM_POWERSAVE<<4|SM_POWERSAVE_PS, sm_powersave},
  // mod0回到时间显示模式 
  {SM_POWERSAVE<<4|SM_POWERSAVE_PS, EV_KEY_MOD_PRESS, SM_DISPLAY<<4|SM_DISPLAY_HHMMSS, sm_display},
  // set0回到时间显示模式
  {SM_POWERSAVE<<4|SM_POWERSAVE_PS, EV_KEY_SET_PRESS, SM_DISPLAY<<4|SM_DISPLAY_HHMMSS, sm_display},
  // 闹铃响了，唤醒吧
  {SM_POWERSAVE<<4|SM_POWERSAVE_PS, EV_ALARM0, SM_ALARM<<4|SM_ALARM_HIT_ALARM0, sm_alarm},
  {SM_POWERSAVE<<4|SM_POWERSAVE_PS, EV_ALARM1, SM_ALARM<<4|SM_ALARM_HIT_ALARM1, sm_alarm},
};  

static const struct sm_trans code sm_trans_clock_alarm[] = {  
  /* SM_ALARM */
  // mod0回到时间显示模式
  {SM_ALARM<<4|SM_ALARM_HIT_ALARM0, EV_KEY_MOD_PRESS, SM_DISPLAY<<4|SM_DISPLAY_HHMMSS, sm_display},
  // set0回到时间显示模式
  {SM_ALARM<<4|SM_ALARM_HIT_ALARM0, EV_KEY_SET_PRESS, SM_DISPLAY<<4|SM_DISPLAY_HHMMSS, sm_display}, 
  // mod0回到时间显示模式
  {SM_ALARM<<4|SM_ALARM_HIT_ALARM1, EV_KEY_MOD_PRESS, SM_DISPLAY<<4|SM_DISPLAY_HHMMSS, sm_display},
  // set0回到时间显示模式
  {SM_ALARM<<4|SM_ALARM_HIT_ALARM1, EV_KEY_SET_PRESS, SM_DISPLAY<<4|SM_DISPLAY_HHMMSS, sm_display}, 
};
...
static const struct sm_trans code sm_trans_clock_counter[] = {  
  ...
  // set0 暂停倒计时
  {SM_COUNTER<<4|SM_COUNTER_RUNNING, EV_KEY_SET_PRESS, SM_COUNTER<<4|SM_COUNTER_PAUSE, sm_counter}, 
  // set0 继续倒计时
  {SM_COUNTER<<4|SM_COUNTER_PAUSE, EV_KEY_SET_PRESS, SM_COUNTER<<4|SM_COUNTER_RUNNING, sm_counter},
  // mod0 清除
  {SM_COUNTER<<4|SM_COUNTER_PAUSE, EV_KEY_MOD_PRESS, SM_COUNTER<<4|SM_COUNTER_MODIFY_HH, sm_counter},
  // 倒计时结束，响铃
  {SM_COUNTER<<4|SM_COUNTER_RUNNING, EV_COUNTER, SM_COUNTER<<4|SM_COUNTER_STOP, sm_counter},
  // mod0 停止响铃
...
static const struct sm_trans code sm_trans_fuse_test[] = {  
  ...
  // mod1 切换回时钟模式
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE0_SHORT, EV_KEY_MOD_LPRESS, SM_DISPLAY<<4|SM_DISPLAY_INIT, sm_display},
  // set1 切换到模式选择
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE0_SHORT, EV_KEY_SET_LPRESS, SM_FUSE_MODE<<4|SM_FUSE_MODE_INIT, sm_fuse_mode},
   // modset1 切换到参数设置
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE0_SHORT, EV_KEY_MOD_LPRESS, SM_FUSE_MODE<<4|SM_FUSE_PARAM_INIT, sm_fuse_param},
  ...
  // mod1 切换回时钟模式
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE0_BROKE, EV_KEY_MOD_LPRESS, SM_DISPLAY<<4|SM_DISPLAY_INIT, sm_display},
  // set1 切换到模式选择
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE0_BROKE, EV_KEY_SET_LPRESS, SM_FUSE_MODE<<4|SM_FUSE_MODE_INIT, sm_fuse_mode},
   // modset1 切换到参数设置
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE0_BROKE, EV_KEY_MOD_LPRESS, SM_FUSE_MODE<<4|SM_FUSE_PARAM_INIT, sm_fuse_param},
  ...
  // mod1 切换回时钟模式
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE1_SHORT, EV_KEY_MOD_LPRESS, SM_DISPLAY<<4|SM_DISPLAY_INIT, sm_display},
  // set1 切换到模式选择
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE1_SHORT, EV_KEY_SET_LPRESS, SM_FUSE_MODE<<4|SM_FUSE_MODE_INIT, sm_fuse_mode},
   // modset1 切换到参数设置
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE1_SHORT, EV_KEY_MOD_LPRESS, SM_FUSE_MODE<<4|SM_FUSE_PARAM_INIT, sm_fuse_param},
  ...
  // mod1 切换回时钟模式
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE1_BROKE, EV_KEY_MOD_LPRESS, SM_DISPLAY<<4|SM_DISPLAY_INIT, sm_display},
  // set1 切换到模式选择
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE1_BROKE, EV_KEY_SET_LPRESS, SM_FUSE_MODE<<4|SM_FUSE_MODE_INIT, sm_fuse_mode},
   // modset1 切换到参数设置
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE1_BROKE, EV_KEY_MOD_LPRESS, SM_FUSE_MODE<<4|SM_FUSE_PARAM_INIT, sm_fuse_param},
  ...
  // mod1 切换回时钟模式
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_TRIPWIRE, EV_KEY_MOD_LPRESS, SM_DISPLAY<<4|SM_DISPLAY_INIT, sm_display},
  // set1 切换到模式选择
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_TRIPWIRE, EV_KEY_SET_LPRESS, SM_FUSE_MODE<<4|SM_FUSE_MODE_INIT, sm_fuse_mode},
   // modset1 切换到参数设置
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_TRIPWIRE, EV_KEY_MOD_LPRESS, SM_FUSE_MODE<<4|SM_FUSE_PARAM_INIT, sm_fuse_param},
  ...
  // mod1 切换回时钟模式
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_THERMO_HI, EV_KEY_MOD_LPRESS, SM_DISPLAY<<4|SM_DISPLAY_INIT, sm_display},
  // set1 切换到模式选择
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_THERMO_HI, EV_KEY_SET_LPRESS, SM_FUSE_MODE<<4|SM_FUSE_MODE_INIT, sm_fuse_mode},
   // modset1 切换到参数设置
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_THERMO_HI, EV_KEY_MOD_LPRESS, SM_FUSE_MODE<<4|SM_FUSE_PARAM_INIT, sm_fuse_param},
  ...
  // mod1 切换回时钟模式
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_THERMO_LO, EV_KEY_MOD_LPRESS, SM_DISPLAY<<4|SM_DISPLAY_INIT, sm_display},
  // set1 切换到模式选择
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_THERMO_LO, EV_KEY_SET_LPRESS, SM_FUSE_MODE<<4|SM_FUSE_MODE_INIT, sm_fuse_mode},
   // modset1 切换到参数设置
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_THERMO_LO, EV_KEY_MOD_LPRESS, SM_FUSE_MODE<<4|SM_FUSE_PARAM_INIT, sm_fuse_param},
  
  // set0启动测试
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_HG, EV_KEY_SET_PRESS, SM_FUSE_TEST<<4|SM_FUSE_TEST_HG, sm_fuse_test},
  // 收到EV_ROTATE，更新显示
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_HG, EV_ROTATE, SM_FUSE_TEST<<4|SM_FUSE_TEST_HG, sm_fuse_test},
  // mod0 切换到测试 gyro
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_HG, EV_KEY_MOD_PRESS, SM_FUSE_TEST<<4|SM_FUSE_TEST_GYRO, sm_fuse_test},
  // mod1 切换回时钟模式
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_HG, EV_KEY_MOD_LPRESS, SM_DISPLAY<<4|SM_DISPLAY_INIT, sm_display},
  // set1 切换到模式选择
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_HG, EV_KEY_SET_LPRESS, SM_FUSE_MODE<<4|SM_FUSE_MODE_INIT, sm_fuse_mode},
   // modset1 切换到参数设置
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_HG, EV_KEY_MOD_LPRESS, SM_FUSE_MODE<<4|SM_FUSE_PARAM_INIT, sm_fuse_param},
  
  // set0启动测试
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_GYRO, EV_KEY_SET_PRESS, SM_FUSE_TEST<<4|SM_FUSE_TEST_GYRO, sm_fuse_test},
  // 收到EV_ROTATE，更新显示
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_GYRO, EV_ROTATE, SM_FUSE_TEST<<4|SM_FUSE_TEST_GYRO, sm_fuse_test},
  // 收到EV_ACC，更新显示
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_GYRO, EV_ACC, SM_FUSE_TEST<<4|SM_FUSE_TEST_GYRO, sm_fuse_test},
  ...
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_GYRO, EV_KEY_MOD_PRESS, SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE0_SHORT, sm_fuse_test},
   // mod1 切换回时钟模式
  {SM_FUSE_TEST<<4|SM_FUSE_TEST_GYRO, EV_KEY_MOD_SET_LPRESS, SM_DISPLAY<<4|SM_DISPLAY_INIT, sm_display},
  // set1 切换到模式选择
...
static const struct sm_trans code sm_trans_fuse_timer[] = { 
  ...
  // 姿态变化,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, EV_ROTATE, SM_FUSE_DETONATE<<4|SM_FUSE_DETONATE_INIT, sm_fuse_detonate},
  // 加速度变化,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, EV_ACC, SM_FUSE_DETONATE<<4|SM_FUSE_DETONATE_INIT, sm_fuse_detonate},
  // 温度太高,触发
...
static const struct sm_trans code sm_trans_fuse_grenade[] = { 
  ...
  // 收到EV_ACC,测试加速度改变
  {SM_FUSE_GRENADE<<4|SM_FUSE_GRENADE_PRE_ARMED, EV_ACC, SM_FUSE_GRENADE<<4|SM_FUSE_GRENADE_PRE_ARMED, sm_fuse_grenade},
  // 如果是脱手（失重），进入ARMED
...
static const struct sm_trans code sm_trans_fuse_powersave[] = { 
  ...
  // 姿态变化,触发
  {SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PS, EV_ROTATE, SM_FUSE_DETONATE<<4|SM_FUSE_DETONATE_INIT, sm_fuse_detonate},
  // 加速度变化,触发
  {SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PS, EV_ACC, SM_FUSE_DETONATE<<4|SM_FUSE_DETONATE_INIT, sm_fuse_detonate},
  // 温度太高,触发
