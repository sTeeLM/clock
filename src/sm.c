...
static const struct sm_trans code sm_trans_fuse_test[] = {  
  ...
  // 收到 EV_FUSE_TRIPWIRE 更新显示
  {SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_TRIPWIRE, EV_FUSE_TRIPWIRE, SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_TRIPWIRE, sm_fuse_test},
  // 收到EV_1S，更新状态
  ...
  // mod0 切换到测试 mpu
  {SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_HG, EV_KEY_MOD_PRESS, SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_MPU, sm_fuse_test},
  // mod1 切换回时钟模式
  ...
  // set0启动测试
  {SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_MPU, EV_KEY_SET_PRESS, SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_MPU, sm_fuse_test},
  // 收到EV_ROTATE，更新显示
  {SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_MPU, EV_ROTATE_MPU, SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_MPU, sm_fuse_test},
  // 收到EV_ACC，更新显示
  {SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_MPU, EV_ACC_MPU, SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_MPU, sm_fuse_test},
  // 收到EV_DROP，更新显示
  {SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_MPU, EV_DROP_MPU, SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_MPU, sm_fuse_test},  
  // 收到EV_1S，更新状态
  {SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_MPU, EV_1S, SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_MPU, sm_fuse_test},
  // mod0 切换到测试 fuse0 short
  {SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_MPU, EV_KEY_MOD_PRESS, SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE0_BROKE, sm_fuse_test},
   // mod1 切换回时钟模式
  {SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_MPU, EV_KEY_MOD_LPRESS, SM_CLOCK, SM_CLOCK_DISPLAY<<4|SM_CLOCK_DISPLAY_INIT, sm_clock_display},
  // set1 切换到参数设置
  {SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_MPU, EV_KEY_SET_LPRESS, SM_FUSE, SM_FUSE_PARAM<<4|SM_FUSE_PARAM_INIT, sm_fuse_param},
};
...
static const struct sm_trans code sm_trans_fuse_param[] = { 
  ...
  // mod0 切换MPU on/off
  {SM_FUSE, SM_FUSE_PARAM<<4|SM_FUSE_PARAM_HG_ONOFF, EV_KEY_MOD_PRESS, SM_FUSE, SM_FUSE_PARAM<<4|SM_FUSE_PARAM_MPU_ONOFF, sm_fuse_param},
  // mod1 切换到模式选择
  {SM_FUSE, SM_FUSE_PARAM<<4|SM_FUSE_PARAM_HG_ONOFF, EV_KEY_MOD_LPRESS, SM_FUSE, SM_FUSE_MODE<<4|SM_FUSE_MODE_INIT, sm_fuse_mode},
  // set0 调整MPU on/off
  {SM_FUSE, SM_FUSE_PARAM<<4|SM_FUSE_PARAM_MPU_ONOFF, EV_KEY_SET_PRESS, SM_FUSE, SM_FUSE_PARAM<<4|SM_FUSE_PARAM_MPU_ONOFF, sm_fuse_param},  
  // mod0 切换THERMO_HI on/off
  {SM_FUSE, SM_FUSE_PARAM<<4|SM_FUSE_PARAM_MPU_ONOFF, EV_KEY_MOD_PRESS, SM_FUSE, SM_FUSE_PARAM<<4|SM_FUSE_PARAM_THERMO_HI_ONOFF, sm_fuse_param},
  // mod1 切换到模式选择
  {SM_FUSE, SM_FUSE_PARAM<<4|SM_FUSE_PARAM_MPU_ONOFF, EV_KEY_MOD_LPRESS, SM_FUSE, SM_FUSE_MODE<<4|SM_FUSE_MODE_INIT, sm_fuse_mode},
  ...
  // mod0 切换password 
  {SM_FUSE, SM_FUSE_PARAM<<4|SM_FUSE_PARAM_THERMO_LO_ONOFF, EV_KEY_MOD_PRESS, SM_FUSE, SM_FUSE_PARAM<<4|SM_FUSE_PARAM_PASSWORD, sm_fuse_param},
  // set0 调整password 
...
static const struct sm_trans code sm_trans_fuse_timer[] = { 
  ...
  // 姿态变化,触发
  {SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, EV_ROTATE_MPU, SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, sm_fuse_timer},
  // 姿态变化,触发
  {SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, EV_ROTATE_HG, SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, sm_fuse_timer},
  // 姿态变化,触发
  {SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, EV_DROP_MPU, SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, sm_fuse_timer},
  // 加速度变化,触发
  {SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, EV_ACC_MPU, SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, sm_fuse_timer},  
  // tripwire断,触发
  {SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, EV_FUSE_TRIPWIRE, SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, sm_fuse_timer}, 
  // tripwire断,触发
  ...
  // 姿态变化,触发
  {SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_VERIFY, EV_ROTATE_MPU, SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // 姿态变化,触发
  ...
  // 加速度变化,触发
  {SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_VERIFY, EV_ACC_MPU, SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // 温度太高,触发
  ...
  // tripwire剪断,触发
  {SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_VERIFY, EV_FUSE_TRIPWIRE, SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  ...
  // 姿态变化,触发
  {SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, EV_ROTATE_MPU, SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // 姿态变化,触发
  {SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, EV_ROTATE_HG, SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // 加速度变化,触发
  {SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, EV_ACC_MPU, SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // 温度太高,触发
  ...
  // tripwire剪断,触发
  {SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, EV_FUSE_TRIPWIRE, SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
...
static const struct sm_trans code sm_trans_fuse_grenade[] = {
  ...
  // 收到EV_DROP_MPU,确认加速度改变
  {SM_FUSE, SM_FUSE_GRENADE<<4|SM_FUSE_GRENADE_PREARMED, EV_DROP_MPU, SM_FUSE, SM_FUSE_GRENADE<<4|SM_FUSE_GRENADE_ARMED, sm_fuse_grenade},
  // 收到EV_ACC,测试加速度改变
  {SM_FUSE, SM_FUSE_GRENADE<<4|SM_FUSE_GRENADE_ARMED, EV_ACC_MPU, SM_FUSE, SM_FUSE_GRENADE<<4|SM_FUSE_GRENADE_ARMED, sm_fuse_grenade},
...
static const struct sm_trans code sm_trans_fuse_detonate[] = {
  ...
  // 通电状态，mod0进入电路测试
  {SM_FUSE, SM_FUSE_DETONATE<<4|SM_FUSE_DETONATE_CHARGE, EV_KEY_MOD_PRESS, SM_FUSE, SM_FUSE_DETONATE<<4|SM_FUSE_DETONATE_CHARGE, sm_fuse_detonate},
  // 通电满30S
...
static const struct sm_trans code sm_trans_fuse_powersave[] = {
  ...
  // 姿态变化,触发
  {SM_FUSE, SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PS, EV_ROTATE_MPU, SM_FUSE, SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PREDETONATE, sm_fuse_powersave},
  // 姿态变化,触发
  ...
  // 加速度变化,触发
  {SM_FUSE, SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PS, EV_ACC_MPU, SM_FUSE, SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PREDETONATE, sm_fuse_powersave},
  // 温度太高,触发
  ...
  // tripwire剪断,触发
  {SM_FUSE, SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PS, EV_FUSE_TRIPWIRE, SM_FUSE, SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PREDETONATE, sm_fuse_powersave},
