...
static const struct sm_trans code sm_trans_fuse_test[] = {  
  /* SM_FUSE_TEST */
  {SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_INIT, EV_KEY_MOD_UP, SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE0_SHORT, sm_fuse_test},
  // set0启动测试
  {SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE0_SHORT, EV_KEY_SET_PRESS, SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE0_SHORT, sm_fuse_test},
  // 测试fuse0 short 收到EV_FUSE0_SHORT, 更新显示
  {SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE0_SHORT, EV_FUSE0_SHORT, SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE0_SHORT, sm_fuse_test},
  // 测试fuse0 short 收到EV_1S, 更新显示
  {SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE0_SHORT, EV_1S, SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE0_SHORT, sm_fuse_test},
  // mod0 切换到测试fuse0 broke
  {SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE0_SHORT, EV_KEY_MOD_PRESS, SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE0_BROKE, sm_fuse_test},
  // mod1 切换回时钟模式
  {SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE0_SHORT, EV_KEY_MOD_LPRESS, SM_CLOCK, SM_CLOCK_DISPLAY<<4|SM_CLOCK_DISPLAY_INIT, sm_clock_display},
  // set1 切换到参数设置
  {SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE0_SHORT, EV_KEY_SET_LPRESS, SM_FUSE, SM_FUSE_PARAM<<4|SM_FUSE_PARAM_INIT, sm_fuse_param},
  ...
  {SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE0_BROKE, EV_KEY_MOD_PRESS, SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE1_SHORT, sm_fuse_test},
  // mod1 切换回时钟模式
  ...
  // set0启动测试
  {SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE1_SHORT, EV_KEY_SET_PRESS, SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE1_SHORT, sm_fuse_test},
  // 测试fuse1 short 收到EV_FUSE1_SHORT, 更新显示
  {SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE1_SHORT, EV_FUSE1_SHORT, SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE1_SHORT, sm_fuse_test},
  // 收到EV_1S，更新状态
  {SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE1_SHORT, EV_1S, SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE1_SHORT, sm_fuse_test},
  // mod0 切换到测试 fuse1 broke
  {SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE1_SHORT, EV_KEY_MOD_PRESS, SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE1_BROKE, sm_fuse_test},
  // mod1 切换回时钟模式
  {SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE1_SHORT, EV_KEY_MOD_LPRESS, SM_CLOCK, SM_CLOCK_DISPLAY<<4|SM_CLOCK_DISPLAY_INIT, sm_clock_display},
  // set1 切换到参数设置
  {SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE1_SHORT, EV_KEY_SET_LPRESS, SM_FUSE, SM_FUSE_PARAM<<4|SM_FUSE_PARAM_INIT, sm_fuse_param},
  ...
  {SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_GYRO, EV_KEY_MOD_PRESS, SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_FUSE0_SHORT, sm_fuse_test},
   // mod1 切换回时钟模式
...
static const struct sm_trans code sm_trans_fuse_timer[] = { 
  ...
  // fuse0短路,触发
  {SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, EV_FUSE0_SHORT, SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, sm_fuse_timer},
  // fuse0剪断,触发
  ...
  // fuse1短路,触发
  {SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, EV_FUSE1_SHORT, SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, sm_fuse_timer},
  // fuse1剪断,触发
  ...
  // fuse0短路,触发
  {SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_VERIFY, EV_FUSE0_SHORT, SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // fuse0剪断,触发
  ...
  // fuse1短路,触发
  {SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_VERIFY, EV_FUSE1_SHORT, SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // fuse1剪断,触发
  ...
  // fuse0短路,触发
  {SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, EV_FUSE0_SHORT, SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // fuse0剪断,触发
  ...
  // fuse1短路,触发
  {SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, EV_FUSE1_SHORT, SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // fuse1剪断,触发
...
static const struct sm_trans code sm_trans_fuse_powersave[] = {
  ...
  // fuse0短路,触发
  {SM_FUSE, SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PS, EV_FUSE0_SHORT, SM_FUSE, SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PREDETONATE, sm_fuse_powersave},
  // fuse0剪断,触发
  ...
  // fuse1短路,触发
  {SM_FUSE, SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PS, EV_FUSE1_SHORT, SM_FUSE, SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PREDETONATE, sm_fuse_powersave},
  // fuse1剪断,触发
