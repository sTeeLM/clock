...
static const struct sm_trans code sm_trans_clock_mod_alarm[] = {
  ...
  // mod0进入修改HH状态
  {SM_CLOCK, SM_CLOCK_MODIFY_ALARM<<4|SM_CLOCK_MODIFY_ALARM_DUR, EV_KEY_MOD_PRESS, SM_CLOCK, SM_CLOCK_MODIFY_ALARM<<4|SM_CLOCK_MODIFY_ALARM_INIT, sm_clock_mod_alarm_init},
