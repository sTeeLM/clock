...
static const struct sm_trans code sm_trans_clock_display[] = 
{
  ...
  // 1S探测下睡眠超时时间
  {SM_CLOCK_DISPLAY<<4|SM_CLOCK_DISPLAY_HHMMSS, EV_1S, SM_CLOCK_DISPLAY<<4|SM_CLOCK_DISPLAY_HHMMSS, sm_clock_display},
  ...
  // 闹钟0响了
  {SM_CLOCK_DISPLAY<<4|SM_CLOCK_DISPLAY_YYMMDD, EV_ALARM0, SM_CLOCK_ALARM<<4|SM_CLOCK_ALARM_HIT_ALARM0, sm_clock_alarm},
  // 闹钟1响了
  {SM_CLOCK_DISPLAY<<4|SM_CLOCK_DISPLAY_YYMMDD, EV_ALARM1, SM_CLOCK_ALARM<<4|SM_CLOCK_ALARM_HIT_ALARM1, sm_clock_alarm},
  // 1S探测下自动切回时间
  ...
  // 闹钟0响了
  {SM_CLOCK_DISPLAY<<4|SM_CLOCK_DISPLAY_WEEK, EV_ALARM0, SM_CLOCK_ALARM<<4|SM_CLOCK_ALARM_HIT_ALARM0, sm_clock_alarm},
  // 闹钟1响了
  {SM_CLOCK_DISPLAY<<4|SM_CLOCK_DISPLAY_WEEK, EV_ALARM1, SM_CLOCK_ALARM<<4|SM_CLOCK_ALARM_HIT_ALARM1, sm_clock_alarm},  
  // 1S探测下自动切回时间
  ...
  // 闹钟0响了
  {SM_CLOCK_DISPLAY<<4|SM_CLOCK_DISPLAY_TEMP, EV_ALARM0, SM_CLOCK_ALARM<<4|SM_CLOCK_ALARM_HIT_ALARM0, sm_clock_alarm},
  // 闹钟1响了
  {SM_CLOCK_DISPLAY<<4|SM_CLOCK_DISPLAY_TEMP, EV_ALARM1, SM_CLOCK_ALARM<<4|SM_CLOCK_ALARM_HIT_ALARM1, sm_clock_alarm},
  // 1S探测下自动切回时间
...
static const struct sm_trans code sm_trans_fuse_mode[] = {  
  ...
  // EV_1S刷新显示
  {SM_FUSE_MODE<<4|SM_FUSE_MODE_TIMER, EV_1S, SM_FUSE_MODE<<4|SM_FUSE_MODE_TIMER, sm_fuse_mode},
  // set0 模式选择
  ...
  // EV_1S刷新显示
  {SM_FUSE_MODE<<4|SM_FUSE_MODE_GRENADE, EV_1S, SM_FUSE_MODE<<4|SM_FUSE_MODE_GRENADE, sm_fuse_mode},
};

static const struct sm_trans code sm_trans_fuse_param[] = { 
  /* SM_FUSE_PARAM */
  {SM_FUSE_PARAM<<4|SM_FUSE_PARAM_INIT, EV_KEY_SET_UP, SM_FUSE_PARAM<<4|SM_FUSE_PARAM_YY, sm_fuse_param},
  // set0/1 调整年
  ...
  // mod1 切换到模式选择
  {SM_FUSE_PARAM<<4|SM_FUSE_PARAM_YY, EV_KEY_MOD_LPRESS, SM_FUSE_MODE<<4|SM_FUSE_MODE_INIT, sm_fuse_mode},
  // set0/1 调整月
  ...
  // mod0 切换调整时
  {SM_FUSE_PARAM<<4|SM_FUSE_PARAM_MO, EV_KEY_MOD_PRESS, SM_FUSE_PARAM<<4|SM_FUSE_PARAM_DD, sm_fuse_param},
  // mod1 切换到模式选择
  {SM_FUSE_PARAM<<4|SM_FUSE_PARAM_MO, EV_KEY_MOD_LPRESS, SM_FUSE_MODE<<4|SM_FUSE_MODE_INIT, sm_fuse_mode},
  // set0/1 调整日
  ...
  // mod1 切换到模式选择
  {SM_FUSE_PARAM<<4|SM_FUSE_PARAM_DD, EV_KEY_MOD_LPRESS, SM_FUSE_MODE<<4|SM_FUSE_MODE_INIT, sm_fuse_mode},
  // set0/1 调整时
  ...
  // mod1 切换到模式选择
  {SM_FUSE_PARAM<<4|SM_FUSE_PARAM_HH, EV_KEY_MOD_LPRESS, SM_FUSE_MODE<<4|SM_FUSE_MODE_INIT, sm_fuse_mode},
  // set0/1 调整分
  ...
  // mod1 切换到模式选择
  {SM_FUSE_PARAM<<4|SM_FUSE_PARAM_MM, EV_KEY_MOD_LPRESS, SM_FUSE_MODE<<4|SM_FUSE_MODE_INIT, sm_fuse_mode},
  // set0/1 调整秒
  ...
  // mod1 切换到模式选择
  {SM_FUSE_PARAM<<4|SM_FUSE_PARAM_SS, EV_KEY_MOD_LPRESS, SM_FUSE_MODE<<4|SM_FUSE_MODE_INIT, sm_fuse_mode},
  // set0 调整HG on/off
  ...
  // mod1 切换到模式选择
  {SM_FUSE_PARAM<<4|SM_FUSE_PARAM_HG_ONOFF, EV_KEY_MOD_LPRESS, SM_FUSE_MODE<<4|SM_FUSE_MODE_INIT, sm_fuse_mode},
  // set0 调整GYRO on/off
  ...
  // mod1 切换到模式选择
  {SM_FUSE_PARAM<<4|SM_FUSE_PARAM_GYRO_ONOFF, EV_KEY_MOD_LPRESS, SM_FUSE_MODE<<4|SM_FUSE_MODE_INIT, sm_fuse_mode},
  ...
  {SM_FUSE_PARAM<<4|SM_FUSE_PARAM_THERMO_HI_ONOFF, EV_KEY_SET_LPRESS, SM_FUSE_PARAM<<4|SM_FUSE_PARAM_THERMO_HI_ONOFF, sm_fuse_param},
  {SM_FUSE_PARAM<<4|SM_FUSE_PARAM_THERMO_HI_ONOFF, EV_KEY_SET_UP, SM_FUSE_PARAM<<4|SM_FUSE_PARAM_THERMO_HI_ONOFF, sm_fuse_param},  
  ...
  // mod1 切换到模式选择
  {SM_FUSE_PARAM<<4|SM_FUSE_PARAM_THERMO_HI_ONOFF, EV_KEY_MOD_LPRESS, SM_FUSE_MODE<<4|SM_FUSE_MODE_INIT, sm_fuse_mode},
  ...
  {SM_FUSE_PARAM<<4|SM_FUSE_PARAM_THERMO_LO_ONOFF, EV_KEY_SET_LPRESS, SM_FUSE_PARAM<<4|SM_FUSE_PARAM_THERMO_LO_ONOFF, sm_fuse_param},
  {SM_FUSE_PARAM<<4|SM_FUSE_PARAM_THERMO_LO_ONOFF, EV_KEY_SET_UP, SM_FUSE_PARAM<<4|SM_FUSE_PARAM_THERMO_LO_ONOFF, sm_fuse_param},
  ...
  // mod1 切换到模式选择
  {SM_FUSE_PARAM<<4|SM_FUSE_PARAM_THERMO_LO_ONOFF, EV_KEY_MOD_LPRESS, SM_FUSE_MODE<<4|SM_FUSE_MODE_INIT, sm_fuse_mode},
  ...
  // mod1 切换到模式选择
  {SM_FUSE_PARAM<<4|SM_FUSE_PARAM_TRIPWIRE_ONOFF, EV_KEY_MOD_LPRESS, SM_FUSE_MODE<<4|SM_FUSE_MODE_INIT, sm_fuse_mode},
  // set0 调整password 
  {SM_FUSE_PARAM<<4|SM_FUSE_PARAM_PASSWORD, EV_KEY_SET_PRESS, SM_FUSE_PARAM<<4|SM_FUSE_PARAM_PASSWORD, sm_fuse_param},
  {SM_FUSE_PARAM<<4|SM_FUSE_PARAM_PASSWORD, EV_KEY_SET_LPRESS, SM_FUSE_PARAM<<4|SM_FUSE_PARAM_PASSWORD, sm_fuse_param},
  {SM_FUSE_PARAM<<4|SM_FUSE_PARAM_PASSWORD, EV_KEY_SET_UP, SM_FUSE_PARAM<<4|SM_FUSE_PARAM_PASSWORD, sm_fuse_param},  
  // mod0 下一数字
...
static const struct sm_trans code sm_trans_fuse_timer[] = { 
  /* SM_FUSE_TIMER */ 
  // 过1秒进入prearmed状态
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_INIT, EV_1S, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, sm_fuse_timer},
  // 设置参数
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, EV_1S, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, sm_fuse_timer}, 
  // 设置成功，准备干活了
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, EV_FUSE_SEL1, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, sm_fuse_timer},
  // 参数设置不成功，进入电路测试
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, EV_FUSE_SEL0, SM_FUSE_TEST<<4|SM_FUSE_TEST_INIT, sm_fuse_test},
  // 计时器时间到,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, EV_COUNTER, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, sm_fuse_timer},
  // fuse0短路,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, EV_FUSE0_SHORT, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, sm_fuse_timer},
  // fuse0剪断,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, EV_FUSE0_BROKE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, sm_fuse_timer},
  // fuse1短路,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, EV_FUSE1_SHORT, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, sm_fuse_timer},
  // fuse1剪断,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, EV_FUSE1_BROKE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, sm_fuse_timer},
  // 姿态变化,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, EV_ROTATE_GYRO, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, sm_fuse_timer},
  // 姿态变化,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, EV_ROTATE_HG, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, sm_fuse_timer},
  // 姿态变化,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, EV_DROP_GYRO, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, sm_fuse_timer},
  // 加速度变化,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, EV_ACC_GYRO, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, sm_fuse_timer},  
  // tripwire断,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, EV_TRIPWIRE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, sm_fuse_timer}, 
  // tripwire断,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, EV_THERMO_HI, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, sm_fuse_timer}, 
  // tripwire断,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, EV_THERMO_LO, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, sm_fuse_timer}, 
  
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, EV_1S, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, sm_fuse_timer},
  // set0在显示日期和hhmmss之间来回切换
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, EV_KEY_SET_PRESS, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, sm_fuse_timer},
  // mod0 空操作，更新睡眠时间  
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, EV_KEY_MOD_PRESS, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, sm_fuse_timer}, 
  // mod0 进入密码验证
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, EV_KEY_MOD_PRESS, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_VERIFY, sm_fuse_timer}, 
  // set0修改数字
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_VERIFY, EV_KEY_SET_PRESS, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_VERIFY, sm_fuse_timer},
  // mod0 下一数字
  ...
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_VERIFY, EV_FUSE_SEL0, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_DISARMED, sm_fuse_timer},
  // disarmed状态清除完毕，进入电路测试
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_DISARMED, EV_FUSE_SEL0, SM_FUSE_TEST<<4|SM_FUSE_TEST_INIT, sm_fuse_test}, 
  // 一次验证失败，返回倒计时
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_VERIFY, EV_FUSE_SEL1, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, sm_fuse_timer},
  // set1,返回倒计时  
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_VERIFY, EV_KEY_SET_LPRESS, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, sm_fuse_param},  
  
  // 三次验证失败,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_VERIFY, EV_FUSE_SEL2, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // 计时器时间到,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_VERIFY, EV_COUNTER, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // fuse0短路,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_VERIFY, EV_FUSE0_SHORT, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // fuse0剪断,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_VERIFY, EV_FUSE0_BROKE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // fuse1短路,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_VERIFY, EV_FUSE1_SHORT, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // fuse1剪断,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_VERIFY, EV_FUSE1_BROKE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // 姿态变化,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_VERIFY, EV_ROTATE_GYRO, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // 姿态变化,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_VERIFY, EV_ROTATE_HG, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // 加速度变化,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_VERIFY, EV_ACC_GYRO, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // 温度太高,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_VERIFY, EV_THERMO_HI, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // 温度太低,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_VERIFY, EV_THERMO_LO, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // tripwire剪断,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_VERIFY, EV_TRIPWIRE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  
  // 计时器时间到,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, EV_COUNTER, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // fuse0短路,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, EV_FUSE0_SHORT, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // fuse0剪断,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, EV_FUSE0_BROKE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // fuse1短路,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, EV_FUSE1_SHORT, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // fuse1剪断,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, EV_FUSE1_BROKE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // 姿态变化,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, EV_ROTATE_GYRO, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // 姿态变化,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, EV_ROTATE_HG, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // 加速度变化,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, EV_ACC_GYRO, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // 温度太高,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, EV_THERMO_HI, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // 温度太低,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, EV_THERMO_LO, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  // tripwire剪断,触发
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, EV_TRIPWIRE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, sm_fuse_timer},
  
  // 清理完毕,进入detonate
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREDETONATE, EV_FUSE_SEL0, SM_FUSE_DETONATE<<4|SM_FUSE_DETONATE_INIT, sm_fuse_detonate},
  
  // 超时，进入节电
  {SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, EV_POWER_SAVE, SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_INIT, sm_fuse_powersave},
};
...
static const struct sm_trans code sm_trans_fuse_detonate[] = { 
  ...
  // 通电状态，mod0进入电路测试
  {SM_FUSE_DETONATE<<4|SM_FUSE_DETONATE_CHARGE, EV_KEY_MOD_PRESS, SM_FUSE_TEST<<4|SM_FUSE_DETONATE_CHARGE, sm_fuse_detonate},
  // 通电满30S
...
static const struct sm_trans code sm_trans_fuse_powersave[] = { 
  ...
  // 计时器时间到,触发
  {SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PS, EV_COUNTER, SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PREDETONATE, sm_fuse_powersave},
  // fuse0短路,触发
  {SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PS, EV_FUSE0_SHORT, SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PREDETONATE, sm_fuse_powersave},
  // fuse0剪断,触发
  {SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PS, EV_FUSE0_BROKE, SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PREDETONATE, sm_fuse_powersave},
  // fuse1短路,触发
  {SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PS, EV_FUSE1_SHORT, SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PREDETONATE, sm_fuse_powersave},
  // fuse1剪断,触发
  {SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PS, EV_FUSE1_BROKE, SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PREDETONATE, sm_fuse_powersave},
  // 姿态变化,触发
  {SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PS, EV_ROTATE_GYRO, SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PREDETONATE, sm_fuse_powersave},
  // 姿态变化,触发
  {SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PS, EV_ROTATE_HG, SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PREDETONATE, sm_fuse_powersave},
  // 加速度变化,触发
  {SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PS, EV_ACC_GYRO, SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PREDETONATE, sm_fuse_powersave},
  // 温度太高,触发
  {SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PS, EV_THERMO_HI, SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PREDETONATE, sm_fuse_powersave},
  // 温度太低,触发
  {SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PS, EV_THERMO_LO, SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PREDETONATE, sm_fuse_powersave},
  // tripwire剪断,触发
  {SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PS, EV_TRIPWIRE, SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PREDETONATE, sm_fuse_powersave},
  
  {SM_FUSE_POWERSAVE<<4|SM_FUSE_POWERSAVE_PREDETONATE, EV_FUSE_SEL0, SM_FUSE_DETONATE<<4|SM_FUSE_DETONATE_INIT, sm_fuse_detonate},
};  
