...
static const struct sm_trans code sm_trans_clock_mod_alarm[] = {
  ...
  // mod1进入时钟显示
  {SM_CLOCK, SM_CLOCK_MODIFY_ALARM<<4|SM_CLOCK_MODIFY_ALARM_MM, EV_KEY_MOD_LPRESS, SM_CLOCK, SM_CLOCK_DISPLAY<<4|SM_CLOCK_DISPLAY_INIT, sm_clock_display_init},
  ...
  // mod1进入时钟显示
  {SM_CLOCK, SM_CLOCK_MODIFY_ALARM<<4|SM_CLOCK_MODIFY_ALARM_DAY, EV_KEY_MOD_LPRESS, SM_CLOCK, SM_CLOCK_DISPLAY<<4|SM_CLOCK_DISPLAY_INIT, sm_clock_display_init},
  ...
  // mod0进入修改DUR状态
  {SM_CLOCK, SM_CLOCK_MODIFY_ALARM<<4|SM_CLOCK_MODIFY_ALARM_BS, EV_KEY_MOD_PRESS, SM_CLOCK, SM_CLOCK_MODIFY_ALARM<<4|SM_CLOCK_MODIFY_ALARM_DUR, sm_clock_mod_alarm_submod4},

  // mod1进入时钟显示
  {SM_CLOCK, SM_CLOCK_MODIFY_ALARM<<4|SM_CLOCK_MODIFY_ALARM_BS, EV_KEY_MOD_LPRESS, SM_CLOCK, SM_CLOCK_DISPLAY<<4|SM_CLOCK_DISPLAY_INIT, sm_clock_display_init},
  
  // set0调整DUR时间，并写入rtc
  {SM_CLOCK, SM_CLOCK_MODIFY_ALARM<<4|SM_CLOCK_MODIFY_ALARM_DUR, EV_KEY_SET_PRESS, SM_CLOCK, SM_CLOCK_MODIFY_ALARM<<4|SM_CLOCK_MODIFY_ALARM_DUR, sm_clock_mod_alarm_submod4},
  // mod0进入修改HH状态
  {SM_CLOCK, SM_CLOCK_MODIFY_ALARM<<4|SM_CLOCK_MODIFY_ALARM_DUR, EV_KEY_MOD_PRESS, SM_CLOCK, SM_CLOCK_MODIFY_ALARM<<4|SM_CLOCK_MODIFY_ALARM_HH, sm_clock_mod_alarm_submod0},
  
  // mod1进入时间显示 
  {SM_CLOCK, SM_CLOCK_MODIFY_ALARM<<4|SM_CLOCK_MODIFY_ALARM_DUR, EV_KEY_MOD_LPRESS, SM_CLOCK, SM_CLOCK_DISPLAY<<4|SM_CLOCK_DISPLAY_INIT, sm_clock_display_init}, 
};
...
static const struct sm_trans code sm_trans_clock_powersave[] = {
  ...
  // EV_ROTATE_HG回到时间显示模式
  {SM_CLOCK, SM_CLOCK_POWERSAVE<<4|SM_CLOCK_POWERSAVE_PS, EV_ROTATE_HG, SM_CLOCK, SM_CLOCK_DISPLAY<<4|SM_CLOCK_DISPLAY_HHMMSS, sm_clock_display_submod0},	
  // 闹铃响了，唤醒吧
...
static const struct sm_trans code sm_trans_power_pack_display[] = {
  ...
  {SM_POWER_PACK, SM_POWER_PACK_DISPLAY<<4|SM_POWER_PACK_DISPLAY_POWER, EV_KEY_MOD_SET_LPRESS, SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_INIT, sm_radio_display_init},  
...
static const struct sm_trans code sm_trans_power_pack_powersave[] = {
  ...
  {SM_POWER_PACK, SM_POWER_PACK_POWERSAVE<<4|SM_POWER_PACK_POWERSAVE_SLEEP, EV_ROTATE_HG, SM_POWER_PACK, SM_POWER_PACK_DISPLAY<<4|SM_POWER_PACK_DISPLAY_POWER, sm_power_pack_display_submod0},

};

static const struct sm_trans code sm_trans_radio_display[] = {
  /* SM_RADIO_DISPLAY */
  {SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_INIT, EV_KEY_MOD_UP, SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_STATION, sm_radio_display_submod0},
  {SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_STATION, EV_KEY_MOD_PRESS, SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_STATION, sm_radio_display_submod0},
  {SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_STATION, EV_KEY_MOD_LPRESS, SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_STATION, sm_radio_display_submod0},
  {SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_STATION, EV_KEY_MOD_UP, SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_STATION, sm_radio_display_submod0},
  {SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_STATION, EV_KEY_SET_PRESS, SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_STATION, sm_radio_display_submod0},
  {SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_STATION, EV_KEY_SET_LPRESS, SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_STATION, sm_radio_display_submod0},
  {SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_STATION, EV_KEY_SET_UP, SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_STATION, sm_radio_display_submod0},
  {SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_STATION, EV_1S, SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_STATION, sm_radio_display_submod0},

  {SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_STATION, EV_KEY_V0, SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_VOLUME, sm_radio_display_submod1},
  {SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_STATION, EV_KEY_MOD_SET_LPRESS, SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_INIT, sm_fuse_test_init},
  {SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_STATION, EV_POWER_SAVE, SM_RADIO, SM_RADIO_POWERSAVE<<4|SM_RADIO_POWERSAVE_INIT, sm_radio_powersave_init},
  
  {SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_VOLUME, EV_KEY_MOD_PRESS, SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_VOLUME, sm_radio_display_submod1},
  {SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_VOLUME, EV_KEY_MOD_LPRESS, SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_VOLUME, sm_radio_display_submod1},
  {SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_VOLUME, EV_KEY_MOD_UP, SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_VOLUME, sm_radio_display_submod1},
  {SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_VOLUME, EV_KEY_SET_PRESS, SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_VOLUME, sm_radio_display_submod1},
  {SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_VOLUME, EV_KEY_SET_LPRESS, SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_VOLUME, sm_radio_display_submod1},
  {SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_VOLUME, EV_KEY_SET_UP, SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_VOLUME, sm_radio_display_submod1},
  {SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_VOLUME, EV_1S, SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_VOLUME, sm_radio_display_submod1},

  {SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_VOLUME, EV_KEY_V0, SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_MOD, sm_radio_display_submod2},
  {SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_VOLUME, EV_KEY_MOD_SET_LPRESS, SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_INIT, sm_fuse_test_init},
  {SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_VOLUME, EV_POWER_SAVE, SM_RADIO, SM_RADIO_POWERSAVE<<4|SM_RADIO_POWERSAVE_INIT, sm_radio_powersave_init},
  
  {SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_MOD, EV_KEY_V0, SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_STATION, sm_radio_display_submod0},
  {SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_MOD, EV_1S, SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_MOD, sm_radio_display_submod2},
  {SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_MOD, EV_KEY_MOD_PRESS, SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_INIT, sm_radio_mod_init},

  {SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_MOD, EV_KEY_MOD_SET_LPRESS, SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_INIT, sm_fuse_test_init},
  {SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_MOD, EV_POWER_SAVE, SM_RADIO, SM_RADIO_POWERSAVE<<4|SM_RADIO_POWERSAVE_INIT, sm_radio_powersave_init},
};

static const struct sm_trans code sm_trans_radio_mod[] = {
  /* SM_RADIO_MOD*/
  {SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_INIT, EV_KEY_MOD_UP, SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_HLSI, sm_radio_mod_submod0},

  {SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_HLSI, EV_KEY_MOD_LPRESS, SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_STATION, sm_radio_display_submod0},

  {SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_HLSI, EV_KEY_SET_PRESS, SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_HLSI, sm_radio_mod_submod0},
  {SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_HLSI, EV_KEY_MOD_PRESS, SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_MS, sm_radio_mod_submod1},

  {SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_MS, EV_KEY_SET_PRESS, SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_MS, sm_radio_mod_submod1},
  {SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_MS, EV_KEY_MOD_PRESS, SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_BL, sm_radio_mod_submod2},

  {SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_BL, EV_KEY_SET_PRESS, SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_BL, sm_radio_mod_submod2},
  {SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_BL, EV_KEY_MOD_PRESS, SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_HCC, sm_radio_mod_submod3},
   
  {SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_HCC, EV_KEY_SET_PRESS, SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_HCC, sm_radio_mod_submod3},
  {SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_HCC, EV_KEY_MOD_PRESS, SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_SNC, sm_radio_mod_submod4},

  {SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_SNC, EV_KEY_SET_PRESS, SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_SNC, sm_radio_mod_submod4},
  {SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_SNC, EV_KEY_MOD_PRESS, SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_DTC, sm_radio_mod_submod5},

  {SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_DTC, EV_KEY_SET_PRESS, SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_DTC, sm_radio_mod_submod5},
  {SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_DTC, EV_KEY_MOD_PRESS, SM_RADIO, SM_RADIO_MOD<<4|SM_RADIO_MOD_HLSI, sm_radio_mod_submod0},
   
};

static const struct sm_trans code sm_trans_radio_powersave[] = {
  /* SM_RADIO_POWERSAVE*/
  {SM_RADIO, SM_RADIO_POWERSAVE<<4|SM_RADIO_POWERSAVE_INIT, EV_250MS, SM_RADIO, SM_RADIO_POWERSAVE<<4|SM_RADIO_POWERSAVE_SLEEP, sm_radio_powersave_submod0},
  {SM_RADIO, SM_RADIO_POWERSAVE<<4|SM_RADIO_POWERSAVE_SLEEP, EV_KEY_SET_PRESS, SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_STATION, sm_radio_display_submod0},
  {SM_RADIO, SM_RADIO_POWERSAVE<<4|SM_RADIO_POWERSAVE_SLEEP, EV_KEY_MOD_PRESS, SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_STATION, sm_radio_display_submod0},
  {SM_RADIO, SM_RADIO_POWERSAVE<<4|SM_RADIO_POWERSAVE_SLEEP, EV_ROTATE_HG, SM_RADIO, SM_RADIO_DISPLAY<<4|SM_RADIO_DISPLAY_STATION, sm_radio_display_submod0},
};
...
static const struct sm_trans code sm_trans_fuse_timer[] = { 
  ...
  {SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, EV_KEY_V1, SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_ARMED, sm_fuse_timer_submod1},
	// 启动传感器不成功，显示错误
	{SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, EV_KEY_MOD_PRESS, SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, sm_fuse_timer_submod0}, 
	{SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, EV_KEY_SET_PRESS, SM_FUSE, SM_FUSE_TIMER<<4|SM_FUSE_TIMER_PREARMED, sm_fuse_timer_submod0}, 
  // 启动传感器不成功，进入电路测试
...
static const struct sm_trans code sm_trans_global_flag_mod[] = {
  ...
  // mod0 进入自动点亮ON/OFF设置
  {SM_GLOBAL_FLAG, SM_GLOBAL_FLAG_MODIFY<<4|SM_GLOBAL_FLAG_MODIFY_PS, EV_KEY_MOD_PRESS, SM_GLOBAL_FLAG, SM_GLOBAL_FLAG_MODIFY<<4|SM_GLOBAL_FLAG_MODIFY_AUTOLIGHT, sm_global_flag_mod_submod1},  
  ...
  // set0 自动点亮ON/OFF
  {SM_GLOBAL_FLAG, SM_GLOBAL_FLAG_MODIFY<<4|SM_GLOBAL_FLAG_MODIFY_AUTOLIGHT, EV_KEY_SET_PRESS, SM_GLOBAL_FLAG, SM_GLOBAL_FLAG_MODIFY<<4|SM_GLOBAL_FLAG_MODIFY_AUTOLIGHT, sm_global_flag_mod_submod1}, 
  // mod0 按键音调整
  {SM_GLOBAL_FLAG, SM_GLOBAL_FLAG_MODIFY<<4|SM_GLOBAL_FLAG_MODIFY_AUTOLIGHT, EV_KEY_MOD_PRESS, SM_GLOBAL_FLAG, SM_GLOBAL_FLAG_MODIFY<<4|SM_GLOBAL_FLAG_MODIFY_BEEP, sm_global_flag_mod_submod2}, 
	
  // set0 按键音ON/OFF
  {SM_GLOBAL_FLAG, SM_GLOBAL_FLAG_MODIFY<<4|SM_GLOBAL_FLAG_MODIFY_BEEP, EV_KEY_SET_PRESS, SM_GLOBAL_FLAG, SM_GLOBAL_FLAG_MODIFY<<4|SM_GLOBAL_FLAG_MODIFY_BEEP, sm_global_flag_mod_submod2}, 
  // mod0 闹铃时间调整
  {SM_GLOBAL_FLAG, SM_GLOBAL_FLAG_MODIFY<<4|SM_GLOBAL_FLAG_MODIFY_BEEP, EV_KEY_MOD_PRESS, SM_GLOBAL_FLAG, SM_GLOBAL_FLAG_MODIFY<<4|SM_GLOBAL_FLAG_MODIFY_1224, sm_global_flag_mod_submod3}, 
  ...
  // mod0 进入设置遥控器
  {SM_GLOBAL_FLAG, SM_GLOBAL_FLAG_MODIFY<<4|SM_GLOBAL_FLAG_MODIFY_1224, EV_KEY_MOD_PRESS, SM_GLOBAL_FLAG, SM_GLOBAL_FLAG_MODIFY<<4|SM_GLOBAL_FLAG_MODIFY_REMOTE, sm_global_flag_mod_submod4}, 

  // set0 遥控器ON/OFF
  {SM_GLOBAL_FLAG, SM_GLOBAL_FLAG_MODIFY<<4|SM_GLOBAL_FLAG_MODIFY_REMOTE, EV_KEY_SET_PRESS, SM_GLOBAL_FLAG, SM_GLOBAL_FLAG_MODIFY<<4|SM_GLOBAL_FLAG_MODIFY_REMOTE, sm_global_flag_mod_submod4},
  // mod0 进入设置省电模式状态
  {SM_GLOBAL_FLAG, SM_GLOBAL_FLAG_MODIFY<<4|SM_GLOBAL_FLAG_MODIFY_REMOTE, EV_KEY_MOD_PRESS, SM_GLOBAL_FLAG, SM_GLOBAL_FLAG_MODIFY<<4|SM_GLOBAL_FLAG_MODIFY_PS, sm_global_flag_mod_submod0}, 
...
static const struct sm_trans_group code sm_group_radio[] = {
  {sm_trans_radio_display, sizeof(sm_trans_radio_display)/ sizeof(struct sm_trans)},
  {sm_trans_radio_mod, sizeof(sm_trans_radio_mod)/ sizeof(struct sm_trans)},
  {sm_trans_radio_powersave, sizeof(sm_trans_radio_powersave)/ sizeof(struct sm_trans)},
};
...
static const struct sm_state_names code sm_radio_names[] = {
  {"SM_RADIO_DISPLAY", sm_radio_display_ss_name}, 
  {"SM_RADIO_MOD", sm_radio_mod_ss_name}, 
  {"SM_RADIO_POWERSAVE", sm_radio_powersave_ss_name},   
  {NULL, NULL}
};
