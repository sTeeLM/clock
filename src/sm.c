...
static const struct sm_trans code sm_trans_global_flag_mod[] = {
  ...
  // mod0 进入设置遥控器
  {SM_GLOBAL_FLAG, SM_GLOBAL_FLAG_MODIFY<<4|SM_GLOBAL_FLAG_MODIFY_1224, EV_KEY_MOD_PRESS, SM_GLOBAL_FLAG, SM_GLOBAL_FLAG_MODIFY<<4|SM_GLOBAL_FLAG_MODIFY_REMOTE, sm_global_flag_mod_submod3}, 

  // set0 遥控器ON/OFF
  {SM_GLOBAL_FLAG, SM_GLOBAL_FLAG_MODIFY<<4|SM_GLOBAL_FLAG_MODIFY_REMOTE, EV_KEY_SET_PRESS, SM_GLOBAL_FLAG, SM_GLOBAL_FLAG_MODIFY<<4|SM_GLOBAL_FLAG_MODIFY_REMOTE, sm_global_flag_mod_submod3},
  // mod0 进入设置省电模式状态
