...
static const struct sm_trans code sm_trans_clock_mod_time[] = {
  ...
  // 每250ms读一次rtc
  {SM_CLOCK, SM_CLOCK_MODIFY_TIME<<4|SM_CLOCK_MODIFY_TIME_HH, EV_250MS, SM_CLOCK, SM_CLOCK_MODIFY_TIME<<4|SM_CLOCK_MODIFY_TIME_HH, sm_clock_mod_time_submod0},
  // mod1 进入修改闹钟模式
  ...
  // 每250ms读一下rtc
  {SM_CLOCK, SM_CLOCK_MODIFY_TIME<<4|SM_CLOCK_MODIFY_TIME_MM, EV_250MS, SM_CLOCK, SM_CLOCK_MODIFY_TIME<<4|SM_CLOCK_MODIFY_TIME_MM, sm_clock_mod_time_submod1}, 
  // mod1 进入修改闹钟模式
  ...
  // 每250ms读一次rtc 
  {SM_CLOCK, SM_CLOCK_MODIFY_TIME<<4|SM_CLOCK_MODIFY_TIME_SS, EV_250MS, SM_CLOCK, SM_CLOCK_MODIFY_TIME<<4|SM_CLOCK_MODIFY_TIME_SS, sm_clock_mod_time_submod2},
  // mod1进入修改闹钟模式
  ...
  // 每250ms读取一次rtc  
  {SM_CLOCK, SM_CLOCK_MODIFY_TIME<<4|SM_CLOCK_MODIFY_TIME_YY, EV_250MS, SM_CLOCK, SM_CLOCK_MODIFY_TIME<<4|SM_CLOCK_MODIFY_TIME_YY, sm_clock_mod_time_submod3},
  // mod1 进入修改闹钟模式  
  ...
  // 每250ms读取一下rtc
  {SM_CLOCK, SM_CLOCK_MODIFY_TIME<<4|SM_CLOCK_MODIFY_TIME_MO, EV_250MS, SM_CLOCK, SM_CLOCK_MODIFY_TIME<<4|SM_CLOCK_MODIFY_TIME_MO, sm_clock_mod_time_submod4},
  // mod1 进入修改闹钟模式  
  ...
  // 每250ms读取一下rtc
  {SM_CLOCK, SM_CLOCK_MODIFY_TIME<<4|SM_CLOCK_MODIFY_TIME_DD, EV_250MS, SM_CLOCK, SM_CLOCK_MODIFY_TIME<<4|SM_CLOCK_MODIFY_TIME_DD, sm_clock_mod_time_submod5}, 
  // mod1 进入修改闹钟模式
...
static const struct sm_trans code sm_trans_power_pack_display[] = {
  ...
  {SM_POWER_PACK, SM_POWER_PACK_DISPLAY<<4|SM_POWER_PACK_DISPLAY_POWER, EV_KEY_SET_LPRESS, SM_FUSE, SM_FUSE_TEST<<4|SM_FUSE_TEST_INIT, sm_fuse_test_init},	
