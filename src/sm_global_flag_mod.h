...
enum sm_global_flag_mod_ss {
  ...
  SM_GLOBAL_FLAG_MODIFY_PS     = 1, // 节电模式超时时间切换：0，15，30
	SM_GLOBAL_FLAG_MODIFY_AUTOLIGHT = 2, // 自动点亮 on/off
  SM_GLOBAL_FLAG_MODIFY_BEEP   = 3, // 按键音
  SM_GLOBAL_FLAG_MODIFY_1224   = 4, // 12/24小时显示切换
  SM_GLOBAL_FLAG_MODIFY_REMOTE = 5  // 遥控器
};
...
void sm_global_flag_mod_submod4(unsigned char from, unsigned char to, enum task_events);
