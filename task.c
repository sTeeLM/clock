...
static const struct sm_trans code sm[] = 
{
  ...
  // mod1 进入修改闹钟模式
  {SM_MODIFY_TIME<<4|SM_MODIFY_TIME_MM, EV_KEY_MOD_LPRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_HH, sm_mod_alarm},
  // mod0进入修改年模式
  ...
  // mod1 进入修改闹钟模式  
  {SM_MODIFY_TIME<<4|SM_MODIFY_TIME_YY, EV_KEY_MOD_LPRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_HH, sm_mod_alarm}, 
  // mod0 进入修改月模式
  ...
  /* SM_MODIFY_ALARM */
  // 从别的状态进入，防止误操作
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM_INIT, EV_KEY_MOD_UP, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_HH, sm_mod_alarm},
  // set0小时++  
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_HH, EV_KEY_SET_PRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_HH, sm_mod_alarm},
  // set1小时持续++
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_HH, EV_KEY_SET_LPRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_HH, sm_mod_alarm},
  // set抬起停止++，写入rtc
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_HH, EV_KEY_SET_UP, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_HH, sm_mod_alarm},
  // mod0进入修改分钟模式
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_HH, EV_KEY_MOD_PRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_MM, sm_mod_alarm},
  // mod1进入修改全局状态模式
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_HH, EV_KEY_MOD_LPRESS, SM_MODIFY_GLOBAL_FLAG<<4|SM_MODIFY_GLOBAL_FLAG_INIT, sm_mod_global_flag},
  // 每1s读取一下rtc
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_HH, EV_1S, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_HH, sm_mod_time}, 
  // set0分钟++
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_MM, EV_KEY_SET_PRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_MM, sm_mod_alarm},
  // set1分钟持续++
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_MM, EV_KEY_SET_LPRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_MM, sm_mod_alarm}, 
  // set抬起停止++，写入rtc  
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_MM, EV_KEY_SET_UP, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_MM, sm_mod_alarm}, 
  // mod0进入打开关闭状态
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_MM, EV_KEY_MOD_PRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_ON, sm_mod_alarm}, 
  // mod1进入修改全局状态模式  
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_MM, EV_KEY_MOD_LPRESS, SM_MODIFY_GLOBAL_FLAG<<4|SM_MODIFY_GLOBAL_FLAG_INIT, sm_mod_global_flag},
  // mod0 进入修改闹钟1小时模式
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_ON, EV_KEY_MOD_PRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM1_HH, sm_mod_alarm},
  // set0 调整打开关闭，并写入rtc
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_ON, EV_KEY_SET_PRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_ON, sm_mod_alarm},  
  // mod1进入修改全局状态模式  
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_ON, EV_KEY_MOD_LPRESS, SM_MODIFY_GLOBAL_FLAG<<4|SM_MODIFY_GLOBAL_FLAG_INIT, sm_mod_global_flag}, 
  // set0小时++
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM1_HH, EV_KEY_SET_PRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM1_HH, sm_mod_alarm},
  // set1小时持续++
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM1_HH, EV_KEY_SET_LPRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM1_HH, sm_mod_alarm},
  // set抬起，停止小时++，写入rtc
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM1_HH, EV_KEY_SET_UP, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM1_HH, sm_mod_alarm}, 
  // mod0 进入设置分钟模式
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM1_HH, EV_KEY_MOD_PRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM1_MM, sm_mod_alarm},
  // mod1 进入设置全局状态模式  
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM1_HH, EV_KEY_MOD_LPRESS, SM_MODIFY_GLOBAL_FLAG<<4|SM_MODIFY_GLOBAL_FLAG_INIT, sm_mod_global_flag}, 
  // set0 分钟++
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM1_MM, EV_KEY_SET_PRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM1_MM, sm_mod_alarm},
  // set1 分钟持续++
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM1_MM, EV_KEY_SET_LPRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM1_MM, sm_mod_alarm}, 
  // set抬起，停止持续++写rtc  
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM1_MM, EV_KEY_SET_UP, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM1_MM, sm_mod_alarm}, 
  // mod0 进入打开关闭状态
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM1_MM, EV_KEY_MOD_PRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM1_ON, sm_mod_alarm}, 
  // mod1 进入设置全局状态模式 
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM1_MM, EV_KEY_MOD_LPRESS, SM_MODIFY_GLOBAL_FLAG<<4|SM_MODIFY_GLOBAL_FLAG_INIT, sm_mod_global_flag},
  // mod0 回到修改闹钟0小时状态
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM1_ON, EV_KEY_MOD_PRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM0_HH, sm_mod_alarm},
  // set0 修改on/off  
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM1_ON, EV_KEY_SET_PRESS, SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM1_ON, sm_mod_alarm}, 
  // mod1 进入设置全局状态模式 
  {SM_MODIFY_ALARM<<4|SM_MODIFY_ALARM1_ON, EV_KEY_MOD_LPRESS, SM_MODIFY_GLOBAL_FLAG<<4|SM_MODIFY_GLOBAL_FLAG_INIT, sm_mod_global_flag}, 
